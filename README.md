...
Geyik 3D, Godot 4 ile geliştirilen **mobil öncelikli, açık dünya birinci şahıs av oyunudur**. Android ve iOS yatay ekran düzeni için tasarlanmıştır; hareket dinamik sol joystick, kamera sağ dokunmatik alan ve bağlama duyarlı eylem düğmeleriyle yönetilir.
...
- `MultiMesh` tabanlı ağaç ve kaya kümeleri; yakın çevrede seçilmiş gövde çarpışmaları.
...
- Prosedürel ses ipuçları; harici model, doku veya ses paketi zorunluluğu yoktur.

## Mobil kontroller

| Bölge / düğme | İşlev |
|---|---|
| Sol ekran | Dokunulan yerde açılan hareket joystick'i |
...
1. Godot 4.3 veya daha yeni sürümde `project.godot` dosyasını içe aktarın.
